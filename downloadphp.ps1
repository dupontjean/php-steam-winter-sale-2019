...
if($PSVersiontable.PSVersion.Major -lt 3)
{
    ...
    Write-Output "Download from: https://windows.php.net/downloads/releases/php-7.4.1-nts-Win32-VC15-x$arch.zip"
...
{
    Invoke-WebRequest -Uri https://windows.php.net/downloads/releases/php-7.4.1-nts-Win32-VC15-x$arch.zip -OutFile php.zip
}
